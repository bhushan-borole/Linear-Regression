...
class Regressor():
	...
	'''
	def gradient_descent(self, X, Y, theta, iterations, learning_rate):
...
def main():
	...
	gradient, cost = regressor.gradient_descent(X, Y, theta, iterations, learning_rate)
	print(gradient, cost)

	final_cost = regressor.compute_cost(X, Y, gradient)
	print(final_cost)
